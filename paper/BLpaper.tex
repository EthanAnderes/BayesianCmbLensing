...
% <-----extra detail
%  &= \left(\frac{d k}{2\pi}\right)^2 \sum_{j=1,2}  \int_{\Bbb R^2} e^{-ix \cdot k} \nabla^j\widetilde T(x+\nabla \phi(x))\left[ i  l_j e^{ix \cdot  l}  - i  l_j e^{-i x \cdot  l}  + i(-  l_j e^{ix \cdot  l}  -  l_j e^{-i x \cdot  l})  \right]\frac{dx}{2\pi} \\
% &= \left(\frac{d k}{2\pi}\right)^2 \sum_{j=1,2} i l_j \int_{\Bbb R^2} e^{-ix \cdot k} \nabla^j\widetilde T(x+\nabla \phi(x))\left[ e^{ix \cdot  l}  -  e^{-i x \cdot  l}  -  e^{ix \cdot  l}  -  e^{-i x \cdot  l} \right]\frac{dx}{2\pi}\\
% <-----
...
% <-----extra detail
  % &= \left(\frac{d k}{2\pi}\right)^2 \sum_{j=1,2}  \int_{\Bbb R^2} e^{-ix \cdot k} \nabla^j\widetilde T(x+\nabla \phi(x))\left[ i  l_j e^{ix \cdot  l}  - i  l_j e^{-i x \cdot  l}  - i(-  l_j e^{ix \cdot  l}  -  l_j e^{-i x \cdot  l})  \right]\frac{dx}{2\pi} \\
  % &= \left(\frac{d k}{2\pi}\right)^2 \sum_{j=1,2}  \int_{\Bbb R^2} e^{-ix \cdot k} \nabla^j\widetilde T(x+\nabla \phi(x))\left[ i  l_j e^{ix \cdot  l}  - i  l_j e^{-i x \cdot  l}  + i  l_j e^{ix \cdot  l}  +i  l_j e^{-i x \cdot  l}  \right]\frac{dx}{2\pi} \\
% &= \sum_{j=1,2}  \frac{i l_j(d k)^2}{2\pi^2}\int_{\Bbb R^2} e^{-ix \cdot (k-l)} \nabla^j\widetilde T(x+\nabla \phi(x))\frac{dx}{2\pi} \\
% <-------
 &=\sum_{j=1,2}\frac{ il_j (dk)^2}{2\pi^2} [(\nabla^j\widetilde T)^\phi]_{k-l}
\end{align}
\end{proof}

...
\begin{aug}
  \author{\fnms{Ethan}  \snm{Anderes}\thanksref{a}\ead[label=e1]{anderes@ucdavis.edu}}
    \and
  \author{\fnms{Benjamin} \snm{Wandelt}\thanksref{b}\ead[label=e2]{?@?}}
  	\and
  \author{\fnms{Guilhem} \snm{Lavaux}\thanksref{b}\ead[label=e3]{?@?}}
  \runauthor{Anderes et al.}
 % \affiliation{University of California, Davis and Stanford University}
  ...
  \address[b]{Institut d' Astrophysique de Paris. \printead{e2}\printead{e3}}
\end{aug}
...
%This is exceedingly important for understanding the nature and structure of matter in the universe. 

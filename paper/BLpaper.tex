...
In this section we present an illustration of the methodology presented above. The simulation truth lensing potential is generated on the flat sky with periodic boundary conditions,  shown at left in Figure \ref{phix fig}. The data is shown at left in Figure \ref{tilde fig}. The pixel width is 2 arcmin with additive noise at each pixel with a variance of $16$. A vertical column in the data is masked which amounts to approximatly .. percent of the total pixels.

The solid 


The middle plots of both 
